...
export default class Src {
  ...
  sendManualCommand(joystick_x, joystick_y, sliderSensibility) {
    ...
    setTimeout(() => {
      WebServer(global.speed, global.steer, global.limit, 0, global.uv);
    }, global.communicationDelay);
  }

  /** Desliga o modo automático. */
  stopAutoMode() {
    sendToLidarServer(0, 0, 0, 0, 0, 0, 0);
  }
  ...
  stopRobot() {
    global.uv = 0;
    WebServer(0, 0, 0, 0, 0);
    sendToLidarServer(0, 0, 0, 0, 0, -1, -1);
  }
}
