      ...
      <View style={globalStyles.mainContainer}>
        ...
        <View style={Styles.containerTutorial}>
          ...
          <Text style={Styles.tutorialText}>
            3 - Caso o led não se acenda, aguarde 5 segundos, clique novamente em estabelecer
            conexão. Repita esse processo ate o led acender.
          </Text>
          <Text style={Styles.tutorialText}>4 - Com o led aceso clique em ok.</Text>
        </View>

        <View style={Styles.containerButtons}>
          <TouchableOpacity style={Styles.buttonTryConnection} onPress={tryConnection()}>
